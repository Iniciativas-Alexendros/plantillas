...
| 1.7 | Módulo `agent-config` cross-platform                    | Global      | ✅     |
...
| 2.1.7 | Crear `validar_agent_config.py`                                          | Alta      | ✅     | Checks: YAML canónico, campos requeridos, drift de generación cross-platform            |
...
| 2.2.7 | Workflow para `agent-config/`        | Alta      | ✅     | `.github/workflows/validar-agent-config.yml` · paths filter + permisos mínimos |
